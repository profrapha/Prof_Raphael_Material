...
2.8. (TRAVA DE MATERIAL NÃO-CONSUMÍVEL / COMPACTIDADE ABSOLUTA): O material gerado é um Caderno Suplementar de Estudo e Consulta, NÃO um material consumível (o aluno resolve em um caderno à parte). Portanto, é ESTRITAMENTE PROIBIDO inserir espaçamentos verticais artificiais, quebras de linha excessivas, comandos como \vfill, \vspace{...cm} grandes ou margens vazias entre uma questão e outra. As questões devem fluir de forma compacta, contínua e densa, utilizando apenas o espaçamento mínimo padrão (\espacoQuestao) delimitado pela linha divisória.
