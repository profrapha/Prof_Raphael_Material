...
\usepackage[top=1.8cm, bottom=1.8cm, left=0.9cm, right=0.9cm, headheight=22pt, headsep=0.6cm]{geometry}
...
% --- MINI-CABEÇALHO E RODAPÉ EDITORIAL (TWOSIDE) ---
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{} 
...
% --- CABEÇALHO DA PRIMEIRA PÁGINA (Ajustado ao Topo) ---
\noindent
\begin{minipage}{\textwidth}
    \fontfamily{phv}\selectfont
    
    % Título Principal e Professor
    \noindent
    ...
    % Barra divisória e metadados logo acima
    \noindent\rule{\linewidth}{1.2pt}
    \vspace{-0.1cm}
    \footnotesize\textsf{\textbf{ÁREA:} MATEMÁTICA / ÁLGEBRA \hfill \textbf{NÍVEL:} EF II (6º ANO)}
    \vspace{0.1cm}
