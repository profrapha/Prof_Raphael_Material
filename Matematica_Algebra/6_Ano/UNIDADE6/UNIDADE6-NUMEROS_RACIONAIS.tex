...
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{} % Limpa qualquer numeração ou texto padrão
\renewcommand{\headrulewidth}{0pt} % Remove a linha preta padrão do fancyhdr
\fancyhead[C]{\includegraphics[width=\textwidth]{MATEMATICA_6ANO.png}}
